...
def ejecutar_consulta():
    ...
    try:
        ...
        response = client.models.generate_content(
            ...
            contents=(
                "Preséntate brevemente como si fueras mi mejor Amiga, "
                "de toda la vida, danadome un saludo muy cariñoso y "
                "diciéndome lo mucho que te alegra volver a hablar conmigo. "
            )
        )
